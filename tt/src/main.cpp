...
void lrr(){
	...
	if(red){
		...
		while(!(optical_sensor.get_hue()>=200&&optical_sensor.get_hue()<325)){
			roller.move_velocity(60); //50 55
			pros::delay(5);
			if(master.get_digital(pros::E_CONTROLLER_DIGITAL_Y)){
			return;
			x++;
		...
		while(!(optical_sensor.get_hue()>=200&&optical_sensor.get_hue()<325)){ //320
			roller.move_velocity(80); //50
			pros::delay(5);
			if(master.get_digital(pros::E_CONTROLLER_DIGITAL_Y)){
			return;
			if(pros::millis()-startm > 5000) return;
...
void awp(){
	...
	targetVelocity2 = -100;
	targetVelocity = -100;
	fa.move_velocity(-300);
	fb.move_velocity(-300);

	nw.move_velocity(-600);
	se.move_velocity(-560);
	ne.move_velocity(-560);
	sw.move_velocity(-600);
	pros::delay(400); //180
	nw.move_velocity(0);
	se.move_velocity(0);
...
void rs(){
	...
	ki = 1;
	//pros::delay(700);
	targetVelocity2 = 342; //545 142 340
	targetVelocity = 342;
	intake.move_velocity(600);
...
fb.move_velocity(-600);
	nw.move_velocity(-500);
	se.move_velocity(-500);
	ne.move_velocity(-500);
	sw.move_velocity(-500);
	pros::delay(400); //180
	nw.move_velocity(0);
	se.move_velocity(0);
	ne.move_velocity(0);
...
nw.move_velocity(200);
	se.move_velocity(200);
	ne.move_velocity(200);
	sw.move_velocity(200);
	pros::delay(900);
	nw.move_velocity(0);
	se.move_velocity(0);
	ne.move_velocity(0);
